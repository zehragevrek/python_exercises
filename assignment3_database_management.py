...
# In this homework, you will implement a (very) simple database management system for our custom database
# query language. Your program should ask for queries to execute until program termination.
